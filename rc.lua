...
beautiful.init("/home/reus/.config/awesome/zenburn/theme.lua")
...
once.run("/media/store/script/potd.py")
once.run("python2 /media/store/opt/goagent/local/proxy.py")
once.run("/media/store/script/ssh_vps")
